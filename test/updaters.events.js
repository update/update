...
var updaters = require('..');

describe('updaters events', function() {
  describe('generator', function() {
    ...
    it('should emit generator when base.updaters.get is called', function(cb) {
    ...
    it('should emit generator.get when base.updaters.get is called', function(cb) {
      base.on('generator', function(generator) {
        assert.equal(generator.alias, 'foo');
        cb();
      });
    ...
    it('should emit errors on base from deeply nested updaters', function(cb) {
      var called = 0;
    ...
    it('should bubble up errors to all parent updaters', function(cb) {
      var called = 0;
