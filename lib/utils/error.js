...
function PluginError(plugin, message, options) {
  ...
  if (typeof opts.error === 'object') {
    ...
    utils.unique(keys.concat(nonEnumerable)).forEach(function(prop) {
...
PluginError.prototype._messageDetails = function() {
  ...
  var props = utils.difference(keys, ignore);
...
function defaults (opts) {
  return utils.extend({showStack: false, showProperties: true}, opts);
}
