...
module.exports = function(namespace, config) {
  ...
  Runner.prototype.registerEach = function(patterns, options) {
    // var res = resolve(this, patterns, options);
    ...
    function resolve(patterns, options) {
      var opts = utils.extend({}, options);
      return opts.resolveGlobal !== true
        ? utils.glob.sync(patterns, opts)
        : utils.resolve(patterns, opts);
    }
    return this;
  };
