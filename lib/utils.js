...
var fs = require('fs');
var debug = require('debug')('update:utils');
...
exports.tryStat = function tryStat(fp) {
  try {
...
exports.trailingSlash = function trailingSlash(fp, stat) {
  debug('utils:trailingSlash: %s', fp);
